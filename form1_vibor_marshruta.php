...
include("sergei.php");
?>
<div style="width: 80%; margin: 0 auto; height: 5%;">
<h4> <!--onclick='$("#dsf").toggle()' style='text-decoration:underline'--><a href="#" style="a: #ddd300; color: #ddd300; a:hover: #ddd300; ">Авторские маршруты (кликай)</a></h4>
</div>
